...
function App() {
  ...
  const commands: CommandItem[] = useMemo(() => [
    ...
    },
    {
      ...
      action: () => { setActiveSettingsTab('tools'); },
      category: 'Settings',
    },
    {
      id: 'settings-mcp',
      ...
      action: () => { setActiveSettingsTab('mcp'); },
      category: 'Settings',
    },
    {
      id: 'settings-skills',
      ...
      action: () => { setActiveSettingsTab('skills'); },
      category: 'Settings',
    },
    {
      id: 'settings-memory',
      ...
      action: () => { setActiveSettingsTab('memory'); },
      category: 'Settings',
    },
    {
      ...
      action: () => { setActiveSettingsTab('evolution'); },
      category: 'Settings',
    },
    {
      ...
      action: () => { setActiveSettingsTab('permissions'); },
      category: 'Settings',
    },
    {
      id: 'toggle-theme',
