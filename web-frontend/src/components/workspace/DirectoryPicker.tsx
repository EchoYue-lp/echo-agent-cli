...
export default function DirectoryPicker({
  ...
  return (
    <Modal
      ...
      className="flex max-h-[70vh] w-[500px] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-xl border border-[var(--border-primary)] bg-[var(--bg-primary)] shadow-[var(--shadow-xl)]"
    >
      {/* Header */}
      <div
