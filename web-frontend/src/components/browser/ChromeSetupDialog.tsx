...
export function ChromeSetupDialog({
  ...
  return (
    <Modal
      onClose={onClose}
      ariaLabelledBy="chrome-setup-title"
      overlayClassName="z-[70] p-4"
      className="flex w-full max-w-[520px] flex-col overflow-hidden rounded-lg border border-[var(--border-primary)] bg-[var(--bg-primary)] shadow-2xl"
    >
      ...
      <div className="space-y-4 p-4">
        ...
        <section className="space-y-2">
          <div className="text-xs font-medium text-[var(--text-primary)]">2. 连接并选择标签页</div>
          <p className="text-xs leading-relaxed text-[var(--text-tertiary)]">
