...
harness on one fixed clean commit for real sequential 12/24/48-hour durations,
recording evidence in `docs/2026-08-17-eko-long-horizon-runtime-m5-evaluation.md`.
