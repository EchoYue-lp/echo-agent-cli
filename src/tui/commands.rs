...
impl SlashCommand {
    ...
    pub fn category(self) -> Category {
        match self {
            Self::Reset | Self::History | Self::Stats | Self::Status | Self::New | Self::Compact => {
                Category::Session
            }
            Self::Mode | Self::Model | Self::Think | Self::System | Self::Memory
            | Self::Remember | Self::Forget => Category::Context,
